...
class ImageTypeSearchFilterForm extends EntityListFilterForm implements FormOptionsInterface
{
    protected ImageTypeManagerInterface $typeManager;
    protected RouterInterface $router;

    public function __construct(ImageTypeManagerInterface $typeManager, RouterInterface $router)
    {
    ...
    public function formOptions($object, Request $request): array
    {
        return [
            ...
            'action' => $this->router->generate('sfs_image_admin_images_search_type', ['valid_types' => $request->attributes->get('valid_types')]),
        ];
    }
}